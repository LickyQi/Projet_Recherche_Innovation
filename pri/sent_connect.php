<?php
    ...
    /*
     * @author LI Qi
     * This php is a function to to sent a e-mail to inform the connection error
     */
    ...
    if (isset($_POST['send_email'])){
        ...
        if(empty($email_add)){
            ...
            try {
                ...
                $mail->Body = $_SESSION['error'];
                
                $mail->send();
                echo '<script>alert("The Message has been sent!");location.href="sent_connect.php";</script>';
            } catch (Exception $e) {
...
<html>
    ...
    <body>
        <div style="margin-top:30px;margin-left:30px">
            <a href="index.php" class="btn btn-primary btn-sm active" tabindex="-1" role="button" aria-pressed="true">Back</a>
        </div>
        <br/>
        ...
        <tr>
            <form action="sent_connect.php" method="post" style="text-align:center">
